...
const STREAMS = [
  {
    "token": "merry-xmas",
    "url": 'https://ice31.securenetsystems.net/XMASFMM',
    "metadata" : {
      "title": "Chirstmas FM",
      "subtitle": "Bringing you the magic of Christmas",
      "art": {
        "sources": [
          {
...
const PlayStreamIntentHandler = {
  ...
  handle(handlerInput) {
    ...
    handlerInput.responseBuilder
      ...
      .addAudioPlayerPlayDirective('REPLACE_ALL', stream.url, stream.token);
...
const ExceptionEncounteredRequestHandler = {
  ...
  handle(handlerInput) {
    console.log(`Errored Session ended with reason: ${handlerInput.requestEnvelope.request.reason}`);
